      ...
      <AnimatePresence>
        {open && results.length > 0 && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl z-[9999] overflow-hidden max-h-[60vh] overflow-y-auto"
          >
            {results.map((item, i) => {
